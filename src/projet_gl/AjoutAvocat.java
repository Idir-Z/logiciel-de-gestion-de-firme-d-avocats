 ...
 * @author HP
 */
public class AjoutAvocat extends javax.swing.JFrame {
   private static DefaultComboBoxModel<String> model = null;
   public static AjoutAvocat fentre;
 public static  String[] mois = {
    ...
    public static AjoutAvocat ouvrirFenetreAjoutAvocat(){
        if(fentre == null){
            fentre = new AjoutAvocat();
    ...
    private AjoutAvocat() {
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutAvocat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static void remplirComboBoxAvocat(){
        Connection con = DBConnection.etablirConnection();
        
        try{
            String req = "SELECT  `idAvocat` FROM `avocat`";
            PreparedStatement statement = con.prepareStatement(req);
            ResultSet resultat = statement.executeQuery();
            Vector<String> items = new Vector<>();
            while(resultat.next()){
                String item = resultat.getString("idAvocat");
                items.add(item);
            }
             model = new DefaultComboBoxModel<>(items);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new AjoutAvocat().setVisible(true);
            }
        });
