 ...
 * @author HP
 */
public class AjoutContact extends javax.swing.JFrame {
private static AjoutContact fentre = null;
    /**
    ...
    private AjoutContact() {
        initComponents();
    }
    
    public static AjoutContact ouvrirFnetreAjoutContact(){
        if(fentre==null){
            fentre = new AjoutContact();
        }
        return fentre;      
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutContact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjoutContact().setVisible(true);
            }
        });
    }
