 ...
 * @author HP
 */
public class AjoutSecreataire extends javax.swing.JFrame {
   private static DefaultComboBoxModel<String> model = null;
    public static AjoutSecreataire fentre;
 public static  String[] mois = {
    ...
    private AjoutSecreataire() {
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutSecreataire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JFrame ouvrirFenetreAjoutAvocat(){
        if(fentre == null){
            fentre = new AjoutSecreataire();
    ...
    private void initComponents() {
        ...
        departementCombBox.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Avocat", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 14), new java.awt.Color(51, 51, 51))); // NOI18N
    ...
    AjoutContact f = AjoutContact.ouvrirFnetreAjoutContact();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        f = (AjoutContact)AjoutContact.ouvrirFnetreAjoutContact();
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new AjoutSecreataire().setVisible(true);
            }
        });
